...
subtitle: "Learn to generate your own football players"
author: Miguel Mendez
image: "/assets/images/fullsize/posts/2019-02-06-vae-fifa/thumbnail.jpg"
description: "Learn to generate synthetic faces of FIFA football players using Variational Autoencoders (VAEs) and Tensorflow. Download and scrap a public dataset, train the model and see what players are generated from each country"
selected: y
...
I spent a few hours thinking about which dataset could I use to apply all the knowledge and lines of code I acquired learning about VAEs.
